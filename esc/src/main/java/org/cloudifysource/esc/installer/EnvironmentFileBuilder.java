...
public class EnvironmentFileBuilder {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(EnvironmentFileBuilder.class.getName());
    ...
    public EnvironmentFileBuilder(final ScriptLanguages scriptLanguage, final Map<String, String> externalEnvVars) {
    ...
    private String createSpringProfilesString(final InstallationDetails details) {
        ...
        final String storageProfile = (details.isPersistent() ? CloudifyConstants.PERSISTENCE_PROFILE_PERSISTENT : CloudifyConstants.PERSISTENCE_PROFILE_TRANSIENT);
